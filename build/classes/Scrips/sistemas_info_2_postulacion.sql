...
--
-- Host: 127.0.0.1    Database: sistemas_info_2
-- ------------------------------------------------------
...
CREATE TABLE `postulacion` (
  ...
  `Numero_Registro_Unico` varchar(50) NOT NULL,
  `Fecha_Envio` varchar(50) NOT NULL,
  `Confirmacion_Enviada` tinyint(1) DEFAULT '0',
  `Celular` varchar(20) NOT NULL,
  PRIMARY KEY (`ID_Postulacion`),
  UNIQUE KEY `Numero_Registro_Unico` (`Numero_Registro_Unico`),
  KEY `ID_Usuario` (`ID_Usuario`),
  CONSTRAINT `postulacion_ibfk_1` FOREIGN KEY (`ID_Usuario`) REFERENCES `usuario` (`ID_Usuario`)
...
-- Dump completed on 2025-09-25 16:21:26
