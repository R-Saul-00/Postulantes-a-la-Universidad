...
public class DAO {
    ...
    public RegistroDocumentacion insertarRegistroDocumentacion(RegistroDocumentacion objRegistroDoc) {
        ...
        try (Connection objConexion = ConecBasePrueba.conectar();
            ...
            objPreparedStatement.setString(2, objRegistroDoc.getStrCodigoCertificadoPromo());
            objPreparedStatement.setBoolean(3, objRegistroDoc.getBolEstadoDocumentacion());
            objPreparedStatement.setString(4, objRegistroDoc.getStrFechaRegistroAdmin());
            objPreparedStatement.setBoolean(5, objRegistroDoc.getBolEstadoDePago());
            objPreparedStatement.setString(6, objRegistroDoc.getStrMunicipio());
            objPreparedStatement.setString(7, objRegistroDoc.getStrDepartamento());
            objPreparedStatement.setString(8, objRegistroDoc.getStrFacultad());
            objPreparedStatement.setString(9, objRegistroDoc.getStrCarrera());
            objPreparedStatement.setString(10, objRegistroDoc.getStrCelular());
            ...
            System.err.println("Error al insertar registro de documentación: " + objExcepcionSQL.getMessage());
            return null;
        }
    }
